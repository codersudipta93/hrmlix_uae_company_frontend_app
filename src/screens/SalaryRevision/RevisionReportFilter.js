...
const RevisionReportFilter = props => {
    ...
    const _applyFilter = () => {
        let paramData = {
            ...
            "attendance_month": selectMonth?.value,
            "attendance_year": selectedYear?.value,
        }

        props.navigation.navigate(props?.route?.params?.revision_report_type == "arearSlip" ? 'ArrearSlip' : 'CalculatedRevision', { paramData: paramData, revision_report_type: props?.route?.params?.revision_report_type })
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ paddingHorizontal: 14, marginTop: 12 }}>
                        ...
                        <View style={{ padding: 12, backgroundColor: colors.white, borderRadius: 8, marginBottom: 20 }}>
                            ...
                            {props?.route?.params?.revision_report_type == "monthlywages" || props?.route?.params?.revision_report_type == "arearSlip" ? <>
                            ...
                            <FloatingDropdown
                                ...
                                placeholderColor="#8A8E9C"
                                inputColor={colors.primary}
                                inputMargin={props?.route?.params?.revision_report_type == "monthlywages" || props?.route?.params?.revision_report_type == "arearSlip" ? 18 : 0}
                            />
...
export default RevisionReportFilter;