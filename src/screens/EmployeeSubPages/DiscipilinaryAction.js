...
const DiscipilinaryAction = props => {
  ...
  useEffect(() => {
    if (props?.route?.params) {
      ...
      console.log(props?.route?.params?.paramData?.emp_det?.employment_disciplinary_details);
    }
  }, []);
    ...
    <>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
            <View>
              <Text style={{ textTransform: 'capitalize', fontFamily: FontFamily.medium, color: index == selectedIndex ? '#fff' : '#4E525E', fontSize: sizes.md + 1, textAlign: 'left' }}>
                {item?.disciplinary_type ? item?.disciplinary_type : "N/A"}
              </Text>
      ...
      {index == selectedIndex ?
        <View style={{ paddingLeft: 6 }}>
          ...
          <View style={{ flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', padding:12 }}>
            <View>
              <Text style={[styles.optionname, { marginTop: 8, fontFamily: FontFamily.medium }]}>Comment</Text>
            </View>
            <View style={{ paddingRight: 12 }}>
              <Text style={[styles.optionVal, { textTransform: 'capitalize', fontSize: sizes.md, marginTop: 6, fontFamily: FontFamily.regular }]}>
  ...
  return (
    <SafeAreaView style={styles.main}>
      <View style={styles.main}>
        ...
        <CustomHeader
          buttonText={t('Disciplinary Action')}
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{ paddingHorizontal: 14, flexDirection: 'column', justifyContent: 'space-between', marginTop: 12 }}>
            ...
            {isLoading ? (
              ...
              // Show actual data
              props?.route?.params?.paramData?.emp_det?.training != "" ?
                <>
                  <FlatList
                    showsVerticalScrollIndicator={false}
                    data={props?.route?.params?.paramData?.emp_det?.employment_disciplinary_details}
...
export default DiscipilinaryAction;