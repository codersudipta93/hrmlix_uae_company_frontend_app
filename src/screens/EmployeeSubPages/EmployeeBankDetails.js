...
const EmployeeBankDetails = props => {
    ...
    const showImage = () => {
        ...
        if(empdata?.emp_det?.bank_details?.cancel_cheque){
        setIsLoading(true);
        let param = { image_path: empdata?.emp_det?.bank_details?.cancel_cheque }
                    ...
                    <View style={{ paddingHorizontal: 14, flexDirection: 'column', justifyContent: 'space-between', marginTop: 6 }}>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <View style={{ paddingHorizontal: 12 }}>
                                    <Text style={{ fontFamily: FontFamily.medium, color: '#202020', fontSize: sizes.md, textAlign: 'left' }}>
                                        {empdata?.emp_det?.bank_details?.bank_name ? empdata?.emp_det?.bank_details?.bank_name : "N/A"}
                                    </Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.listCard, { paddingVertical: 22, marginBottom: 0, borderRadius: 0, borderTopRightRadius: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }]}>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <View style={{ paddingHorizontal: 12 }}>
                                    <Text style={{ fontFamily: FontFamily.medium, color: '#202020', fontSize: sizes.md, textAlign: 'left' }}>
                                        {empdata?.emp_det?.bank_details?.branch_name ? empdata?.emp_det?.bank_details?.branch_name : "N/A"}
                                    </Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.listCard, { paddingVertical: 22, marginBottom: 0, borderRadius: 0, borderTopRightRadius: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }]}>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <View style={{ paddingHorizontal: 12 }}>
                                    <Text style={{ fontFamily: FontFamily.medium, color: '#202020', fontSize: sizes.md, textAlign: 'left' }}>
                                        {empdata?.emp_det?.bank_details?.branch_address ? empdata?.emp_det?.bank_details?.branch_address : "N/A"}
                                    </Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.listCard, { paddingVertical: 22, marginBottom: 0, borderRadius: 0, borderTopRightRadius: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }]}>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <View style={{ paddingHorizontal: 12 }}>
                                    <Text style={{ fontFamily: FontFamily.medium, color: '#202020', fontSize: sizes.md, textAlign: 'left' }}>
                                        {empdata?.emp_det?.bank_details?.branch_code ? empdata?.emp_det?.bank_details?.branch_code : "N/A"}
                                    </Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.listCard, { paddingVertical: 22, marginBottom: 0, borderRadius: 0, borderTopRightRadius: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }]}>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <View style={{ paddingHorizontal: 12 }}>
                                    <Text style={{ fontFamily: FontFamily.medium, color: '#202020', fontSize: sizes.md, textAlign: 'left' }}>
                                        {empdata?.emp_det?.bank_details?.account_no ? empdata?.emp_det?.bank_details?.account_no : "N/A"}
                                    </Text>
                                </View>
                            </View>
                        </View>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <View style={{ paddingHorizontal: 12 }}>
                                    <Text style={{ fontFamily: FontFamily.medium, color: '#202020', fontSize: sizes.md, textAlign: 'left', textTransform: 'capitalize' }}>
                                        {empdata?.emp_det?.bank_details?.account_type ? empdata?.emp_det?.bank_details?.account_type : "N/A"}
                                    </Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.listCard, { paddingVertical: 22, marginBottom: 0, borderRadius: 0, borderTopRightRadius: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }]}>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <View style={{ paddingHorizontal: 12 }}>
                                    <Text style={{ fontFamily: FontFamily.medium, color: '#202020', fontSize: sizes.md, textAlign: 'left' }}>
                                        {empdata?.emp_det?.bank_details?.routing_no ? empdata?.emp_det?.bank_details?.routing_no : "N/A"}
                                    </Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.listCard, { paddingVertical: 22, marginBottom: 0, borderRadius: 0, borderTopRightRadius: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }]}>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <View style={{ paddingHorizontal: 12 }}>
                                    <Text style={{ fontFamily: FontFamily.medium, color: '#202020', fontSize: sizes.md, textAlign: 'left' }}>
                                        {empdata?.emp_det?.bank_details?.micr_no ? empdata?.emp_det?.bank_details?.micr_no : "N/A"}
                                    </Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.listCard, { paddingVertical: 22, marginBottom: 0, borderRadius: 0, borderTopRightRadius: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderBottomRightRadius: 0 }]}>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <View style={{ paddingHorizontal: 12 }}>
                                    <Text style={{ fontFamily: FontFamily.medium, color: '#202020', fontSize: sizes.md, textAlign: 'left' }}>
                                        {empdata?.emp_det?.bank_details?.swift_code ? empdata?.emp_det?.bank_details?.swift_code : "N/A"}
                                    </Text>
                                </View>
                            </View>
                        </View>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <View style={{ paddingHorizontal: 12 }}>
                                    <Text style={{ fontFamily: FontFamily.semibold, color: '#202020', fontSize: sizes.md, textAlign: 'left' }}>
                                        {empdata?.emp_det?.bank_details?.iban ? empdata?.emp_det?.bank_details?.iban : "N/A"}
                                    </Text>
                                </View>
                            </View>
                        </View>
                        ...
                        <View style={[styles.listCard, { paddingVertical: 22, marginBottom: 0, borderRadius: 0, borderTopRightRadius: 0, borderTopLeftRadius: 0, borderBottomLeftRadius: 8, borderBottomRightRadius: 8 }]}>
                            ...
                            <View style={{ width: '40%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}>
                                <Pressable onPress={() => { showImage() }} style={{ paddingHorizontal: 12 }}>
