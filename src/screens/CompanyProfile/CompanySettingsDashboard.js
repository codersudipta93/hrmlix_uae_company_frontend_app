...
const CompanySettingsDashboard = props => {
          ...
          <View style={{ marginTop: 18, paddingHorizontal: 12 }}>
            <Pressable onPress={() => { props.navigation.navigate('ProfileAndPartnerdetails') }} style={[styles.cardContainer, { backgroundColor: '#C9EEFC' }]}>
              ...
              <View style={styles.rightSection}>
                <Text style={styles.cardText}>Company Profile</Text>
              </View>
            </Pressable>

            <Pressable onPress={() => { props.navigation.navigate('GovtRule') }} style={[styles.cardContainer, { backgroundColor: '#FCE8E9' }]}>
              <View style={[styles.leftSection, {}]}>
              ...
              <View style={styles.rightSection}>
                <Text style={styles.cardText}>Goverment Rule</Text>
              </View>
            </Pressable>

            <Pressable style={[styles.cardContainer, { backgroundColor: '#DBDAFE' }]}>
              <View style={[styles.leftSection, {}]}>
              ...
              <View style={styles.rightSection}>
                <Text style={styles.cardText}>Company Rule</Text>
              </View>
            </Pressable>
          </View>
        </ScrollView>
