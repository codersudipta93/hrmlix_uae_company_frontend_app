...
const PrefferanceSettings = props => {
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ paddingHorizontal: 14, flexDirection: 'column', justifyContent: 'space-between', marginTop: 4 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10, }}>
                            <Text style={{ fontFamily: FontFamily.semibold, color: '#4E525E', fontSize: sizes.h6, lineHeight: 35 }}>Preference Settings Details</Text>
                        ...
                        {isLoading ? (
                            ...
                            // Show actual data
                            companyData?.preference_settings != "" ?
                                <View>
                                    <View style={styles.listContainer}>
                                        <View>
                                            <Text style={styles.optionname}>Gratuity Rule Select</Text>
                                        </View>
                                        <View style={{ paddingRight: 12 }}>
                                            <Text style={styles.optionVal}>{companyData?.preference_settings?.gratuity_rule}</Text>
                                        </View>
                                    </View>

                                    <View style={styles.listContainer}>
                                        <View>
                                            <Text style={styles.optionname}>Bonus Rule Select</Text>
                                        </View>
                                        <View style={{ paddingRight: 12 }}>
                                            <Text style={styles.optionVal}>{companyData?.preference_settings?.bonus_rule}</Text>
                                        </View>
                                    </View>

                                    <View style={styles.listContainer}>
                                        <View>
                                            <Text style={styles.optionname}>Define Financial Year End</Text>
                                        </View>
                                        <View style={{ paddingRight: 12 }}>
                                            <Text style={styles.optionVal}>{HelperFunctions.getDateDDMMYY(companyData?.preference_settings?.financial_year_end)}</Text>
                                        </View>
                                    </View>
...
export default PrefferanceSettings;