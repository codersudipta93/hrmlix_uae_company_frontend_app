...
const RegisteredOfficeAddress = props => {
    ...
    return (
        <SafeAreaView style={styles.main}>
            <View style={styles.main}>
                ...
                <CustomHeader
                    buttonText={t('Registered Office Address')}
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={{ paddingHorizontal: 14, flexDirection: 'column', justifyContent: 'space-between', marginTop: 4 }}>
                        ...
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10, }}>
                            <Text style={{ fontFamily: FontFamily.semibold, color: '#4E525E', fontSize: sizes.h6, lineHeight: 35 }}>Registered Office Address Details</Text>
                        ...
                        {isLoading ? (
                            ...
                            // Show actual data
                            companyData?.reg_office_address != "" ?
                                <View>
                                    <View style={styles.listContainer}>
                                        ...
                                        <View style={{ paddingRight: 12 }}>
                                            <Text style={styles.optionVal}>{companyData?.reg_office_address?.door_no}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.listContainer}>
                                        ...
                                        <View style={{ paddingRight: 12 }}>
                                            <Text style={styles.optionVal}>{companyData?.reg_office_address?.street_name}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.listContainer}>
                                        ...
                                        <View style={{ paddingRight: 12 }}>
                                            <Text style={styles.optionVal}>{companyData?.reg_office_address?.locality}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.listContainer}>
                                        ...
                                        <View style={{ paddingRight: 12 }}>
                                            <Text style={styles.optionVal}>{companyData?.reg_office_address?.district_name}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.listContainer}>
                                        ...
                                        <View style={{ paddingRight: 12 }}>
                                            <Text style={styles.optionVal}>{companyData?.reg_office_address?.state}</Text>
                                        </View>
                                    </View>
                                    ...
                                    <View style={styles.listContainer}>
                                        ...
                                        <View style={{ paddingRight: 12 }}>
                                            <Text style={[styles.optionVal, { textTransform: 'lowercase' }]}>{companyData?.reg_office_address?.pin_code}</Text>
                                        </View>
                                    </View>
...
const styles = StyleSheet.create({
    ...
    listContainer: { borderBottomWidth:0.8,borderBottomColor:'#E3E3E3', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, paddingHorizontal: 10 },
