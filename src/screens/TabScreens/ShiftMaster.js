...
const ShiftMaster = props => {
  ...
  const placeholderRenderList = ({ index, item }) => (
    <SkeletonLoader width={'95%'} height={90} borderRadius={10} style={{ marginLeft:10,marginTop:6,marginRight:10 }} />
  );
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {isLoading == true ?
            ...
            <View style={{ marginTop: 18, paddingHorizontal: 12 }}>
              <Pressable onPress={() => { props.navigation.navigate('ShiftList', { paramData: empdata }) }} style={[styles.cardContainer, { backgroundColor: '#C9EEFC' }]}>
                ...
                <View style={styles.rightSection}>
                  <Text style={styles.cardText}>Shift List</Text>
                </View>
              </Pressable>

              <Pressable onPress={() => { props.navigation.navigate('ShiftingAllowance') }} style={[styles.cardContainer, { backgroundColor: '#FCE8E9' }]}>
                <View style={[styles.leftSection, {}]}>
                ...
                <View style={styles.rightSection}>
                  <Text style={styles.cardText}>Shift Allowance</Text>
                </View>
              </Pressable>

              <Pressable onPress={() => { props.navigation.navigate('AllocateShift') }} style={[styles.cardContainer, { backgroundColor: '#DBDAFE' }]}>
                <View style={[styles.leftSection, {}]}>
                ...
                <View style={styles.rightSection}>
                  <Text style={styles.cardText}>Allocate Shift</Text>
                </View>
              </Pressable>
              ...
              <Pressable onPress={() => { props.navigation.navigate('ShiftBatch') }} style={[styles.cardContainer, { backgroundColor: '#C9EEFC' }]}>
                ...
                <View style={styles.rightSection}>
                  <Text style={styles.cardText}>Shift Batch</Text>
                </View>
              </Pressable>

              <Pressable onPress={() => {  props.navigation.navigate('ShiftingEarningReport' ) }} style={[styles.cardContainer, { backgroundColor: '#FCE8E9' }]}>
                <View style={[styles.leftSection, {}]}>
                  <ImageBackground source={LOCAL_IMAGES.attendanceCardBG2} style={[styles.background, { width: 75, height: 80 }]}>
                    <View style={styles.container}>
                      <Image source={LOCAL_ICONS.bulletPoint} style={{ height: 35, width: 37, objectFit: 'contain' }} />
                ...
                <View style={styles.rightSection}>
                  <Text style={styles.cardText}>Shift Eraning Report</Text>
                </View>
              </Pressable>

              <Pressable onPress={() => { props.navigation.navigate('ShiftingReport') }} style={[styles.cardContainer, { backgroundColor: '#DBDAFE' }]}>
                <View style={[styles.leftSection, {}]}>
                  <ImageBackground source={LOCAL_IMAGES.attendanceCardBG3} style={[styles.background, { width: 75, height: 80 }]}>
                    <View style={styles.container}>
                      <Image source={LOCAL_ICONS.bulletPoint} style={{ height: 35, width: 37, objectFit: 'contain' }} />
                ...
                <View style={styles.rightSection}>
                  <Text style={styles.cardText}>Shift Duty Report</Text>
                </View>
              </Pressable>
