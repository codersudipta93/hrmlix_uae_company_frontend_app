...
const AnnouncementListSearch = props => {
  ...
  const [qwery, setQwery] = React.useState(""); // modal Open close
  ...
  return (
    <SafeAreaView style={styles.main}>
      <View style={styles.main}>
        ...
        <CustomHeader
          buttonText={t('Search Announcement')}
        ...
        <View style={{paddingHorizontal: 14,  marginTop: 12, flex: 1 }}>
...
export default AnnouncementListSearch;